...
parser.add_argument('--root_dir', type=str, default='.', metavar='S', help='root directory')
...
df = pd.read_csv('../40X.csv')

train_set = breakHis(df.iloc[:-200], args.root_dir)
test_set = breakHis(df.iloc[-200:], args.root_dir)
